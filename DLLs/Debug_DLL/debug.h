...
DEBUG_DLL_API void __stdcall start_log(int current_session_iD, bool delete_old_log);
DEBUG_DLL_API void __stdcall stop_log();
DEBUG_DLL_API void __stdcall clear_log();
DEBUG_DLL_API void __stdcall write_log_vl(bool debug_settings_for_this_message, const char* fmt, va_list vl);
DEBUG_DLL_API void __stdcall write_log(bool debug_settings_for_this_message, const char* fmt, ...);
DEBUG_DLL_API void __stdcall write_log_nostamp(bool debug_settings_for_this_message, const char* fmt, ...);
DEBUG_DLL_API void __stdcall write_log_separator(bool debug_settings_for_this_message, const char* header_message);
